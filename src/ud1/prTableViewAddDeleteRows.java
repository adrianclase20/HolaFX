...
public class prTableViewAddDeleteRows extends Application {
    // Fields to add Person details
    private TextField fNameField;
    private TextField lNameField;
    private DatePicker dobField;
    private TableView<prPerson> table;
    ...
    public void start(Stage stage) {
        ...
        table = new TableView<>(prPersonTableUtil.getPersonList());
        // Turn on multi-row selection for the TableView
        TableViewSelectionModel<prPerson> tsm = table.getSelectionModel();
        tsm.setSelectionMode(SelectionMode.MULTIPLE);
        // Add columns to the TableView
        table.getColumns().addAll(prPersonTableUtil.getIdColumn(), prPersonTableUtil.getFirstNameColumn(), prPersonTableUtil.getLastNameColumn(), prPersonTableUtil.getBirthDateColumn());
    ...
    public void restoreRows() {
        ...
        table.getItems().addAll(prPersonTableUtil.getPersonList());
    }

    public prPerson getPerson() {
        return new prPerson(fNameField.getText(), lNameField.getText(), dobField.getValue());
    }

    public void addPerson() {
        prPerson p = getPerson();
